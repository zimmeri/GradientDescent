...
parser.add_argument('--lr_bgd', type=float, default=0.05, help='Learning rate for gradient descent')
...
parser.add_argument('--lamb', type=float, default=.1, help='Regularization')
